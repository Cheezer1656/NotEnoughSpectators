...
public class PacketStore extends ChannelInboundHandlerAdapter {
    ...
    private static final ArrayList<Packet<?>> CHUNK_PACKETS = new ArrayList<>();
    ...
    public static ArrayList<Packet<?>> getChunkPackets() {
        return (ArrayList<Packet<?>>) CHUNK_PACKETS.clone();
    }
    ...
    public static void addChunkPacket(Packet<?> packet) {
        CHUNK_PACKETS.add(packet);
    }
